...
import InteractiveTextLines from "./InteractiveTextLines.jsx";

gsap.registerPlugin(ScrollTrigger);

const InteractiveHeader = ({ subTitle, title, textParts = [], textColor = "text-white", withScrollTrigger = false }) => {
